...
family-wiki/data/daily.json       하루 요약   ─┼→ cards_data.py (검증) → build_site.py → _site/ → GitHub Pages
family-wiki/data/schedule.json    가족 일정   ─┤
...
- 무엇을 싣고 뺄지는 family-wiki 의 `docs/PRIVACY.md` 와 스키마 다섯 장(`PROFILE_SCHEMA.md` · `PROJECT_SCHEMA.md` ·
